...
var _baseOrderBy = require('../utils/baseOrderBy');

var _baseOrderBy2 = _interopRequireDefault(_baseOrderBy);

var _getIdentifiers = require('../utils/getIdentifiers');

var _getIdentifiers2 = _interopRequireDefault(_getIdentifiers);

var _getOrders = require('../utils/getOrders');
...
function orderBy(collection, identifiers, orders) {
  ...
  var validatedIdentifiers = (0, _getIdentifiers2.default)(identifiers);
  var validatedOrders = (0, _getOrders2.default)(orders);

  return (0, _baseOrderBy2.default)(collection, validatedIdentifiers, validatedOrders);
}
