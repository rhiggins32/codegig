...
var compareMultiple = function compareMultiple(recordA, recordB, orders) {
  var valuesA = recordA.values;
  var valuesB = recordB.values;
...
var createIdentifierFn = function createIdentifierFn(identifier) {
  ...
  return function (value) {
    ...
    } else if (value && (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && typeof identifier !== 'function') {
...
var normalizeChunk = function normalizeChunk(chunk, chunksLength) {
  if (RE_INT_OR_FLOAT.test(chunk) && (!RE_LEADING_ZERO.test(chunk) || chunksLength === 1)) {
...
var isObject = function isObject(value) {
  return value !== null && (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && !Array.isArray(value) && !(value instanceof Number) && !(value instanceof String) && !(value instanceof Boolean) && !(value instanceof Date);
};
...
var getOptions = function getOptions(customOptions) {
  if (!customOptions || (typeof customOptions === 'undefined' ? 'undefined' : _typeof(customOptions)) !== 'object') {
...
//# sourceMappingURL=natural-orderby.es.js.map
